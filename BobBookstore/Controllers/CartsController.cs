...
namespace BobBookstore.Controllers
{
    public class CartsController : Controller
    {
        ...
        public CartsController(UsedBooksContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Cart_Id,IP")] Cart cart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Cart_Id,IP")] Cart cart)
        {
            if (id != cart.Cart_Id)
            {
                return NotFound();
