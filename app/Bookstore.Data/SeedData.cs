    ...
    public partial class ApplicationDbContext : DbContext
    {
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Book>().HasData(
                new Book { Id = 1, Author = "Marley Cobb", PublisherId = 15, ISBN = "6556784356", BookTypeId = 1, Name = "2020 : The Apocalypse", GenreId =13, ConditionId = 5, CoverImageUrl = "/images/coverimages/apocalypse.png", Price = 10.95M, Quantity = 25 },
                new Book { Id = 2, Author = "Merritt Chambers", PublisherId = 16, ISBN = "7665438976", BookTypeId = 1, Name = "Children Of Iron", GenreId = 11, ConditionId = 6, CoverImageUrl = "/images/coverimages/childrenofiron.png", Price = 13.95M, Quantity = 3 },
                new Book { Id = 3, Author = "Lee Schuman", PublisherId = 17, ISBN = "5442280765", BookTypeId = 1, Name = "Gold In The Dark", GenreId = 13, ConditionId = 5, CoverImageUrl = "/images/coverimages/goldinthedark.png", Price = 6.50M, Quantity = 10 },
                new Book { Id = 4, Author = "Vick Hines", PublisherId = 18, ISBN = "4556789542", BookTypeId = 2, Name = "League Of Smokes", GenreId = 11, ConditionId = 7, CoverImageUrl = "/images/coverimages/leagueofsmokes.png", Price = 3M, Quantity = 1 },
                new Book { Id = 5, Author = "Bailey Armstrong", PublisherId = 19, ISBN = "4563358087", BookTypeId = 2, Name = "Alone With The Stars", GenreId = 12, ConditionId = 5, CoverImageUrl = "/images/coverimages/alonewiththestars.png", Price = 15.95M, Quantity = 5 },
                new Book { Id = 6, Author = "Owen Kain", PublisherId = 20, ISBN = "2354435678", BookTypeId = 1, Name = "The Girl In The Polaroid", GenreId = 12, ConditionId = 6, CoverImageUrl = "/images/coverimages/girlinthepolaroid.png", Price = 8.25M, Quantity = 2 },
                new Book { Id = 7, Author = "Adrian Lawrence", PublisherId = 21, ISBN = "6554789632", BookTypeId = 2, Name = "Nana Lawrence 10001 Jokes", GenreId = 11, ConditionId = 5, CoverImageUrl = "/images/coverimages/nana.png", Price = 13.95M, Quantity = 7 },
                new Book { Id = 8, Author = "Harlow Nicholas", PublisherId = 22, ISBN = "4558786554", BookTypeId = 3, Name = "My Search For Meaning", GenreId = 8, ConditionId = 7, CoverImageUrl = "/images/coverimages/mysearchformeaning.png", Price = 5M, Quantity = 15 }
            );
