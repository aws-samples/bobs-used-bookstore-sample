...
namespace BobBookstore.Areas.Identity.Pages.Account.Manage
{
    ...
    public class ManageAccountModel : PageModel
    {
        ...
        private async Task LoadAsync(CognitoUser user)
        {
            ...
            if (Input.FamilyName == "default") Input.FamilyName = "";

            if (Input.Address == "default") Input.Address = "";
            if (Input.Gender == "default") Input.Gender = string.Empty;
            if (Input.NickName == "default") Input.NickName = string.Empty;
            if (Input.GivenName == "default") Input.GivenName = "";
            if (Input.BirthDate == "0000-00-00") Input.BirthDate = "";
            if (Input.PhoneNumber == "+01234567890") Input.PhoneNumber = "";
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (string.IsNullOrWhiteSpace(Input.FamilyName)) Input.FamilyName = "default";
            if (string.IsNullOrWhiteSpace(Input.Address)) Input.Address = "default";
            if (string.IsNullOrWhiteSpace(Input.Gender)) Input.Gender = "default";
            if (string.IsNullOrWhiteSpace(Input.GivenName)) Input.GivenName = "default";
            if (string.IsNullOrWhiteSpace(Input.BirthDate)) Input.BirthDate = "0000-00-00";
            if (string.IsNullOrWhiteSpace(Input.PhoneNumber)) Input.PhoneNumber = "+01234567890";
            if (string.IsNullOrWhiteSpace(Input.NickName)) Input.NickName = "default";
        ...
        public class AccountModel
        {
            ...
            //[Required]
            [Display(Name = "Birth Date ")] public string BirthDate { get; set; }
            ...
            //[Required]
            [Display(Name = "First Name")] public string GivenName { get; set; }
