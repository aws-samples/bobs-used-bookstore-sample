...
namespace BookstoreFrontend.Areas.Identity.Pages.Account.Manage
{
    [AllowAnonymous]
    public class PrimaryAddressEditModel : PageModel
    {
        ...
        public PrimaryAddressEditModel(UserManager<CognitoUser> userManager,
